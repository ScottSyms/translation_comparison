...
# fren  ch=urllib.request.urlopen("https://www.canada.ca/fr/ministere-defense-nationale/organisation/politiques-normes/directives-ordonnances-administratives-defense/serie-5000/5031/5031-50-apprentissage-et-perfectionnement-professionnel-du-personnel-civil.html")
...
french=urllib.request.urlopen("https://chipwired.com/programming-arduino-with-rust/")
...
# Translate the French page into German
params = {
    'api-version': '3.0',
    'from': 'fr',
    'to': ['de']
...
french_from_english=nlpde(translated_from_french)
english_from_french=nlpde(translated_from_english)

# Extract all the significant words from the source English text
keywords_original_english={}
stopwords=list(spacy.lang.en.stop_words.STOP_WORDS)
pos_tag = ['VERB', 'NOUN', 'ADV']
...
# Extract all the significant words fromt the German translated from English
...
# Extract all the significant words from the German translated from the French
...
comparison=set(keywords_translated_from_french.keys()).intersection(set(keywords_original_french.keys()))
...
print("How many words in the English translation", len(keywords_translated_from_english))
print("How many words in the French Translation", len(keywords_translated_from_french))
...
print("Simularity ", (len(comparison)*2/(len(keywords_original_english)+len(keywords_translated_from_french)))*100)
